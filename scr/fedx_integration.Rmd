...
```{r}
fedx1 <- readRDS("~/Data/ABI/proj/sc_mice/fe_2/rds/fedx1_filtered.rds")
fedx2 <- readRDS("~/Data/ABI/proj/sc_mice/fe_2/rds/fedx2_filtered.rds")
```
...
```{r integration, message=FALSE, warning=F, results='hide'}

obj.list <- list(fedx1, fedx2)
...
Integrated seurat object saved in rds/fedx_integrated.rds

```{r save}
saveRDS(seurat, "~/Data/ABI/proj/sc_mice/fe_2/rds/fedx_integrated.rds")
```
